 ...
 */
public class TigerOp3 extends OpMode {
    ...
    public void loop() {
        ...
        final int colorMult = 12;
        int red = colorSensor.red() * colorMult;
        int green = colorSensor.green() * colorMult;
        int blue = colorSensor.blue() * colorMult;
        Color.RGBToHSV(red * red, green * green, blue * blue, hsvValues);

        /***********************************************************
         * COLOR SENSOR ALWAYS ON *TEST*
         ************************************************************/
