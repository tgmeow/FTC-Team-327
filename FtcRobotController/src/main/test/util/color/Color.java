...
public abstract class Color {
    ...
    public static org.lasarobotics.vision.test.util.color.Color create(Scalar s, ColorSpace colorSpace) {
        Class<? extends org.lasarobotics.vision.test.util.color.Color> colorClass = colorSpace.getColorClass();
    ...
    public org.lasarobotics.vision.test.util.color.Color convertColor(ColorSpace to) {
        Scalar output = convertColorScalar(to);

        Class<? extends org.lasarobotics.vision.test.util.color.Color> colorClass = to.getColorClass();
