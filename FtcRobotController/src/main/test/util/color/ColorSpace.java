...
public enum ColorSpace {
    ...
    int[] getConversionsTo(org.lasarobotics.vision.test.util.color.ColorSpace to) {
    ...
    public boolean canConvertTo(org.lasarobotics.vision.test.util.color.ColorSpace to) {
