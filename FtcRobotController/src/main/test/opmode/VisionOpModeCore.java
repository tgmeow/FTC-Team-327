...
abstract class VisionOpModeCore extends OpMode implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected org.lasarobotics.vision.test.util.FPS fps;

    public final void setCamera(org.lasarobotics.vision.test.android.Cameras camera) {
    ...
    public void init() {
        ...
        final org.lasarobotics.vision.test.opmode.VisionOpModeCore t = this;
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                fps = new org.lasarobotics.vision.test.util.FPS();
