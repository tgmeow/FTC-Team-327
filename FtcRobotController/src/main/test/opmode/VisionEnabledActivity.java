...
public abstract class VisionEnabledActivity extends Activity {
     ...
     */
    protected final void initializeVision(int layoutID, org.lasarobotics.vision.test.android.Cameras camera, @Nullable Size frameSize) {
        LinearLayout layout = new LinearLayout(this);
        layout.setOrientation(LinearLayout.VERTICAL);

        if (frameSize == null) {
            org.lasarobotics.vision.test.android.Camera c = camera.createCamera();
            if (c.doesExist()) {
     ...
     * @param camera   The camera to use in vision processing
     */
    protected final void initializeVision(int layoutID, org.lasarobotics.vision.test.android.Cameras camera) {
    ...
    protected final void initializeVision(int layoutID) {
        initializeVision(layoutID, org.lasarobotics.vision.test.android.Cameras.PRIMARY);
    }
