 ...
 */
public class Ellipse extends Detectable implements Comparable<org.lasarobotics.vision.test.detection.objects.Ellipse> {
     ...
     */
    public org.lasarobotics.vision.test.detection.objects.Ellipse scale(double factor) {
        RotatedRect r = rect.clone();
        r.size = new Size(factor * rect.size.width, factor * rect.size.height);
        return new org.lasarobotics.vision.test.detection.objects.Ellipse(r);
    }
     ...
     */
    @Override
    public int compareTo(@NotNull org.lasarobotics.vision.test.detection.objects.Ellipse another) {
