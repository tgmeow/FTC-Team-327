...
public class ObjectDetection {
    ...
    public static void drawKeypoints(Mat output, SceneAnalysis sceneAnalysis) {
        ...
        for (KeyPoint kp : keypoints) {
            org.lasarobotics.vision.test.image.Drawing.drawCircle(output, new Point(kp.pt.x, kp.pt.y), 4, new org.lasarobotics.vision.test.util.color.ColorRGBA(255, 0, 0));
        }
    }
    ...
    public static void drawObjectLocation(Mat output, ObjectAnalysis objectAnalysis, SceneAnalysis sceneAnalysis) {
        ...
        final org.lasarobotics.vision.test.util.color.ColorRGBA lineColor = new org.lasarobotics.vision.test.util.color.ColorRGBA("#00ff00");
        org.lasarobotics.vision.test.image.Drawing.drawLine(output, new Point(cornersScene[0].x + objectAnalysis.object.cols(), cornersScene[0].y),
                new Point(cornersScene[1].x + objectAnalysis.object.cols(), cornersScene[1].y), lineColor, 5);
        org.lasarobotics.vision.test.image.Drawing.drawLine(output, new Point(cornersScene[1].x + objectAnalysis.object.cols(), cornersScene[1].y),
                new Point(cornersScene[2].x + objectAnalysis.object.cols(), cornersScene[2].y), lineColor, 5);
        org.lasarobotics.vision.test.image.Drawing.drawLine(output, new Point(cornersScene[2].x + objectAnalysis.object.cols(), cornersScene[2].y),
                new Point(cornersScene[3].x + objectAnalysis.object.cols(), cornersScene[3].y), lineColor, 5);
        org.lasarobotics.vision.test.image.Drawing.drawLine(output, new Point(cornersScene[3].x + objectAnalysis.object.cols(), cornersScene[3].y),
    ...
    public static void drawDebugInfo(Mat output, SceneAnalysis sceneAnalysis) {
        org.lasarobotics.vision.test.image.Transform.flip(output, org.lasarobotics.vision.test.image.Transform.FlipType.FLIP_ACROSS_Y);
        org.lasarobotics.vision.test.image.Drawing.drawText(output, "Keypoints: " + sceneAnalysis.keypoints.rows(), new Point(0, 8), 1.0f, new org.lasarobotics.vision.test.util.color.ColorRGBA(255, 255, 255), org.lasarobotics.vision.test.image.Drawing.Anchor.BOTTOMLEFT_UNFLIPPED_Y);
        org.lasarobotics.vision.test.image.Transform.flip(output, org.lasarobotics.vision.test.image.Transform.FlipType.FLIP_ACROSS_Y);
    }
