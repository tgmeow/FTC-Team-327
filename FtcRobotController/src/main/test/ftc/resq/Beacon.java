...
public final class Beacon {
    ...
    public BeaconAnalysis analyzeColor(List<org.lasarobotics.vision.test.detection.objects.Contour> contoursRed, List<org.lasarobotics.vision.test.detection.objects.Contour> contoursBlue, Mat img, Mat gray) {
        ...
        org.lasarobotics.vision.test.image.Drawing.drawContours(img, contoursRed, new org.lasarobotics.vision.test.util.color.ColorRGBA("#FFCDD2"), 2);
        org.lasarobotics.vision.test.image.Drawing.drawContours(img, contoursBlue, new org.lasarobotics.vision.test.util.color.ColorRGBA("#BBDEFB"), 2);
        ...
        org.lasarobotics.vision.test.image.Drawing.drawContours(img, BeaconScoring.ScoredContour.getList(scoredContoursRed), new org.lasarobotics.vision.test.util.color.ColorRGBA(255, 0, 0), 2);
        org.lasarobotics.vision.test.image.Drawing.drawContours(img, BeaconScoring.ScoredContour.getList(scoredContoursBlue), new org.lasarobotics.vision.test.util.color.ColorRGBA(0, 0, 255), 2);

        //Locate ellipses in the image to process contours against
        //Each contour must have an ellipse of correct specification
        org.lasarobotics.vision.test.detection.PrimitiveDetection primitiveDetection = new org.lasarobotics.vision.test.detection.PrimitiveDetection();
        org.lasarobotics.vision.test.detection.PrimitiveDetection.EllipseLocationResult ellipseLocationResult = primitiveDetection.locateEllipses(gray);

        //Filter out bad ellipses - TODO filtering currently ignored
        List<org.lasarobotics.vision.test.detection.objects.Ellipse> ellipses = ellipseLocationResult.getEllipses();
        ...
        org.lasarobotics.vision.test.image.Drawing.drawEllipses(img, BeaconScoring.ScoredEllipse.getList(scoredEllipses), new org.lasarobotics.vision.test.util.color.ColorRGBA("#FFC107"), 2);

        //DEBUG draw top 5 ellipses
        if (scoredEllipses.size() > 0) {
            org.lasarobotics.vision.test.image.Drawing.drawEllipses(img, BeaconScoring.ScoredEllipse.getList(scoredEllipses.subList(0, scoredEllipses.size() > 5 ? 5 : scoredEllipses.size()))
                    , new org.lasarobotics.vision.test.util.color.ColorRGBA("#d0ff00"), 3);
            org.lasarobotics.vision.test.image.Drawing.drawEllipses(img, BeaconScoring.ScoredEllipse.getList(scoredEllipses.subList(0, scoredEllipses.size() > 3 ? 3 : scoredEllipses.size()))
                    , new org.lasarobotics.vision.test.util.color.ColorRGBA("#00ff00"), 3);
        }
        ...
        org.lasarobotics.vision.test.detection.objects.Contour bestRed = (associations.redContours.size() > 0) ? associations.redContours.get(0).contour.contour : null;
        org.lasarobotics.vision.test.detection.objects.Contour bestBlue = (associations.blueContours.size() > 0) ? associations.blueContours.get(0).contour.contour : null;
        ...
        org.lasarobotics.vision.test.detection.objects.Contour largestHeight = ((bestRed != null ? bestRed.size().height : 0) >
        ...
        //DEBUG R/B text
        org.lasarobotics.vision.test.image.Drawing.drawText(img, "R", largestRedCenter, 1.0f, new org.lasarobotics.vision.test.util.color.ColorRGBA(255, 0, 0));
        org.lasarobotics.vision.test.image.Drawing.drawText(img, "B", largestBlueCenter, 1.0f, new org.lasarobotics.vision.test.util.color.ColorRGBA(0, 0, 255));
        ...
        org.lasarobotics.vision.test.detection.objects.Contour leftMostContour = ((bestRed.topLeft().x) < (bestBlue.topLeft().x)) ? bestRed : bestBlue;
        //Get the right-most best contour
        org.lasarobotics.vision.test.detection.objects.Contour rightMostContour = ((bestRed.topLeft().x) < (bestBlue.topLeft().x)) ? bestBlue : bestRed;
        ...
        org.lasarobotics.vision.test.image.Drawing.drawRectangle(img, beaconTopLeft, beaconBottomRight, new org.lasarobotics.vision.test.util.color.ColorRGBA(0, 255, 0), 4);
    ...
    public static class BeaconAnalysis {
        ...
        public double getConfidence() {
            return org.lasarobotics.vision.test.util.MathUtil.coerce(0, 1, confidence);
        }
